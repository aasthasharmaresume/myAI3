...
export const AI_NAME = "BITSoM_AI";
export const OWNER_NAME = "Aastha Ananya";

export const WELCOME_MESSAGE = `Hello! I'm ${BITSoM_AI}, an AI assistant created by ${Aastha Ananya}.`
